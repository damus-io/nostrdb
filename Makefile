...
HEADERS = deps/lmdb/lmdb.h deps/secp256k1/include/secp256k1.h src/nostrdb.h src/cursor.h src/hex.h src/jsmn.h src/config.h src/random.h src/memchr.h src/cpu.h src/nostr_bech32.h src/block.h src/str_block.h src/invoice.h src/io.h src/lmdb_util.h src/print_util.h src/protected_queue.h src/threadpool.h src/typedefs.h src/util.h $(C_BINDINGS) $(CCAN_HDRS) $(BOLT11_HDRS)
...
SRCS = src/nostrdb.c src/invoice.c src/nostr_bech32.c src/content_parser.c src/block.c src/protected_queue.c $(BOLT11_SRCS) $(FLATCC_SRCS) $(CCAN_SRCS)
LDS = $(OBJS) $(ARS) 
OBJS = $(SRCS:.c=.o)
